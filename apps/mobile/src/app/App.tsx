          ...
          <View style={styles.section}>
            <View style={styles.hero}>
              <View style={styles.heroTitle}>
                ...
                <Text style={[styles.textLg, styles.heroTitleText]}>Youre up and running</Text>
              </View>
              <TouchableOpacity
                ...
                <Text style={[styles.textMd, styles.textCenter]}>Whats next?</Text>
              </TouchableOpacity>
            </View>
          </View>
          <View style={styles.section}>
            <View style={styles.shadowBox}>
              ...
              <TouchableOpacity
                style={[styles.listItem, styles.learning]}
                onPress={() =>
                  Linking.openURL('https://nx.dev/react-tutorial/1-code-generation?utm_source=nx-project')
                }>
                <Svg width={24} height={24} stroke='#000000' fill='none' viewBox='0 0 24 24'>
                  <Path
                    strokeLinecap='round'
            ...
            <TouchableOpacity onPress={() => Linking.openURL('https://nx.app/?utm_source=nx-project')}>
              <View style={styles.shadowBox}>
                <View style={[styles.listItem, styles.marginBottomMd]}>
                  <Svg width={48} height={48} viewBox='0 0 24 24' stroke='currentColor' fill='transparent'>
                    <Path
                      strokeWidth='2'
          ...
          <View
            ...
            <View style={styles.shadowBox}>
              ...
              <View style={[styles.codeBlock, styles.marginBottomLg]}>
                ...
                <Text style={[styles.textXS, styles.monospace, styles.marginBottomMd]}>nx g @nx/expo:lib ui</Text>
                ...
                <Text style={[styles.textXS, styles.monospace]}>@nx/expo:component \</Text>
              ...
              <View style={styles.codeBlock}>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}># See whats affected by changes</Text>
